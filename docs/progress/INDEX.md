...
| [E14](E14_2026-07-12_sse-offdiagonal-string.md) | 07-12 | SSE非對角弦引擎（熱態⟨X_C⟩，Jarzynski） | ED 4/4＋driver端對端；週期邊界宇稱修復bug；回查QAQMC挖出3 bug（seam cache×2＋閉合宇稱重設）全修——舊two-site測試通過是互償假象 | 完成 |
